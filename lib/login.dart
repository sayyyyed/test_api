...
import 'package:flut_api/firebase_auth_service.dart' as lib1;
import 'package:flut_api/home.dart' as lib2;
...
class _loginState extends State<Login> {
  ...
  void login() async {
    ...
    if (user != null) {
      ...
      //navigator push to  home.dart
      Navigator.push (
        context,
        MaterialPageRoute(builder: (context) => const lib2.User()),
      );
